...
_QUESTION_SEEDS = [
    ...
    {
        "question": "如果今天没有人在注视你，你会做些什么？",
        "context_note": "独处时的选择揭示最真实的自我渴望",
        "category": "自我",
    },
    {
        "question": "有哪些事你一直在坚持，却已忘记最初的理由？",
        "context_note": "定期审视惯性，留出空间给真正重要的事",
        "category": "人生",
    },
    {
        "question": "如果给十年前的自己留一句话，你会说什么？",
        "context_note": "从过往的跋涉中提取最值得坚守的智慧",
        "category": "人生",
    },
    {
        "question": "在今天的工作中，哪一件事最能带来成就感？",
        "context_note": "微小的正向反馈是持续专注的燃料",
        "category": "工作",
    },
    {
        "question": "如果用一件物品形容你目前的生活状态，它会是什么？",
        "context_note": "具象化的隐喻往往能照见潜意识的感受",
        "category": "创造力",
    },
    {
        "question": "你最近给予他人最真诚的一次赞美是什么？",
        "context_note": "真诚的看见与肯定能温柔地照亮彼此",
        "category": "关系",
    },
    {
        "question": "眼下有什么看似阻碍的难题，其实是一个契机？",
        "context_note": "重新定义框架常常能发现隐秘的通路",
        "category": "工作",
    },
    {
        "question": "如果抛开所有评判，你此刻最渴望休息还是创造？",
        "context_note": "倾听身体与心力的真实节律",
        "category": "自我",
    },
    {
        "question": "生命中有哪位偶然相遇的人，曾深深启发过你？",
        "context_note": "那些不经意的微光构成了我们前行的路标",
        "category": "关系",
    },
    {
        "question": "如果你能掌握一门完全未接触过的技艺，会是什么？",
        "context_note": "对未知的好奇是抵御生活庸常的解药",
        "category": "成长",
    },
    {
        "question": "最近一次让你全神贯注忘却时间的时刻是什么？",
        "context_note": "心流体验隐藏着你内心深处的真正热爱",
        "category": "自我",
    },
    {
        "question": "如果今天可以卸下一个心理包袱，你希望是哪一个？",
        "context_note": "允许自己不完美，方能轻装简行",
        "category": "心理",
    },
    {
        "question": "什么样的生活节奏最能让你感到舒适从容？",
        "context_note": "不必追赶每一个风口，找到自己的步频",
        "category": "生活",
    },
    {
        "question": "在与人相处中，你最看重的品质是什么？",
        "context_note": "对品质的偏好映照出我们自身的价值观",
        "category": "关系",
    },
    {
        "question": "你最近读到或听到的最受触动的一句话是什么？",
        "context_note": "共鸣之处往往是我们精神生长的新枝",
        "category": "思维",
    },
    {
        "question": "如果要用三个词概括你现阶段的核心愿望，它们是什么？",
        "context_note": "清晰的目标让选择变得纯粹坚定",
        "category": "自我",
    },
    {
        "question": "有哪些微小的习惯，在不知不觉中重塑了你？",
        "context_note": "微小变量经时间放大便是命运",
        "category": "成长",
    },
    {
        "question": "如果失败没有任何惩罚，你明天最想尝试什么？",
        "context_note": "卸下恐惧才能看清真正的志趣",
        "category": "创造力",
    },
    {
        "question": "你最近一次体验到纯粹的平静是什么时候？",
        "context_note": "宁静是内心秩序重建的标志",
        "category": "生活",
    },
    {
        "question": "对于现阶段的你，什么才是不可妥协的底线？",
        "context_note": "明确边界才能护住内心的净土",
        "category": "自我",
    },
    {
        "question": "有哪些外界的期待，其实并非你真正想要的？",
        "context_note": "学会区分自己的愿望与他人的投射",
        "category": "心理",
    },
    {
        "question": "如果给生活做一次减法，你第一件想舍弃的是什么？",
        "context_note": "少即是多，极简带来更多心力",
        "category": "生活",
    },
    {
        "question": "如果可以对某个人坦白一句真心话，你想对谁说什么？",
        "context_note": "未曾表达的真诚往往是最深的遗憾",
        "category": "关系",
    },
    {
        "question": "哪一位朋友的陪伴，曾给你带来莫大的安全感？",
        "context_note": "被深刻理解与接纳是人生的厚礼",
        "category": "关系",
    },
    {
        "question": "面对不同观点时，你通常是急于辩驳还是好奇倾听？",
        "context_note": "好奇心是跨越认知壁垒的桥梁",
        "category": "思维",
    },
    {
        "question": "在目前所做的事情中，最具长期复利价值的是什么？",
        "context_note": "区分消耗性事务与复利性资产",
        "category": "工作",
    },
    {
        "question": "有什么技能，你觉得在未来十年依然不可替代？",
        "context_note": "专注那些变动世界中不变的本质",
        "category": "成长",
    },
    {
        "question": "你如何定义当下的成功？这个标准来自你自己吗？",
        "context_note": "拿回定义权是走向成熟的第一步",
        "category": "人生",
    },
    {
        "question": "面对繁杂的任务，你通常如何找到关键的支点？",
        "context_note": "抓住主要矛盾，其余迎刃而解",
        "category": "工作",
    },
    {
        "question": "如果把今天当作一部电影的一幕，你希望它是怎样的基调？",
        "context_note": "以旁观者视角审视当下生活",
        "category": "生活",
    },
    {
        "question": "你拥有哪种特质，曾被误认为是缺点，实则是你的长处？",
        "context_note": "独特的特质只是放错了应用场景",
        "category": "自我",
    },
    {
        "question": "如果时间可以慢下来一倍，你最想把时间分给谁？",
        "context_note": "最珍贵的财富永远是注意力与陪伴",
        "category": "关系",
    },
    {
        "question": "面对未知与不确定性，什么念头能给你带来笃定？",
        "context_note": "向内扎根，风暴便只是身外过客",
        "category": "心理",
    },
    {
        "question": "如果能重读一本书并找回初读的感动，你会选哪一本？",
        "context_note": "好书是我们精神原乡的坐标",
        "category": "文化",
    },
    {
        "question": "生活中有哪些不期而遇的温柔，曾瞬间抚平你的疲惫？",
        "context_note": "细心留意微光，生活便处处有诗",
        "category": "生活",
    },
    {
        "question": "面对过去的遗憾，你习惯自责还是从中提炼经验？",
        "context_note": "遗憾是认知升级不可避免的学费",
        "category": "成长",
    },
    {
        "question": "最近有没有哪一刻，让你深刻感受到‘活着真好’？",
        "context_note": "细碎的感知才是生命真实的温度",
        "category": "人生",
    },
    {
        "question": "在嘈杂的信息洪流中，你如何保护自己的专注与独立？",
        "context_note": "保持专注就是守护自己的精神领地",
        "category": "思维",
    },
    {
        "question": "有哪些看似无用的琐事，却能带给你意想不到的治愈？",
        "context_note": "无用之用，往往抚慰最深的疲惫",
        "category": "生活",
    },
    {
        "question": "最近有没有哪次勇敢的‘拒绝’，让你感到由衷的轻松？",
        "context_note": "清晰的拒绝是对自我最深切的守护",
        "category": "自我",
    },
    {
        "question": "你认为一个人真正成熟的核心标志是什么？",
        "context_note": "能为自己的选择承担全部后果与情绪",
        "category": "人生",
    },
    {
        "question": "如果明天是全新的一天，你打算从哪个微小的改变开始？",
        "context_note": "千里之行，始于晨起的一个微小习惯",
        "category": "成长",
    },
]
