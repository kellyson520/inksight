...
_BUILTIN_MODE_IDS = {
    ...
    "XIAOHEIHE_DISCOUNT", "EPIC_FREE", "STEAM_ACHIEVEMENTS", "GCORES_PODCAST",
    "MIYOUSHE_NEWS", "STEAM_RECENT", "STEAM_RANDOM", "STEAM_FRIENDS",
    "GCORES_NEWS", "GCORES_ARTICLES", "GAMERSKY_NEWS", "CHUAPP_ARTICLES",
    "YYSTV_ARTICLES",
}
